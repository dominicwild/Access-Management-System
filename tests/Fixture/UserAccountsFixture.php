...
class UserAccountsFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'user_id' => ['type' => 'text', 'length' => null, 'null' => false, 'default' => null, 'collate' => 'utf8mb4_general_ci', 'comment' => '', 'precision' => null],
        ...
        'domain_admin' => ['type' => 'boolean', 'length' => null, 'null' => false, 'default' => '0', 'comment' => '', 'precision' => null],
        ...
        'date_created' => ['type' => 'datetime', 'length' => null, 'precision' => null, 'null' => true, 'default' => null, 'comment' => ''],
        '_constraints' => [
    ...
    public function init(): void
    {
        $this->records = [
            [
                ...
                'date_created' => '2020-01-31 13:35:30',
            ],
        ];
        parent::init();
    }
